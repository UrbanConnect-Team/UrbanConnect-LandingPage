(function () {
  ...
  function iniciarFormularioModal() {
    ...
    modal.innerHTML =
      '<section class="module-modal-card" role="dialog" aria-modal="true" aria-labelledby="reservasModalTitle">' +
        '<header class="module-modal-header">' +
          '<div><h2 id="reservasModalTitle"></h2><p>Completa los datos del registro.</p></div>' +
